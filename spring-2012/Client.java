...
public class Client{
  ...
  static int RTP_RCV_PORT = 50017; //port where the client will receive the RTP packets
  ...
  private void send_RTSP_request(String request_type)
  {
    try{
      ...
      RTSPBufferedWriter.write(request_type + " " + VideoFileName.toString() + " " + "RTSP/1.0" + CRLF);
